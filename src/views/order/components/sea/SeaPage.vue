  ...
  <div id="app-container">
            ...
            <el-row :gutter="5">
              <el-col :span="14" class="left-content">
                ...
                <el-form-item label="HBL NO." size="small">
                  <el-input :value="order_master.order_extend_info.hbl_no" disabled />
                </el-form-item>
    ...
    <el-col :span="24" style="margin-top: 10px;">
      <el-tabs v-model="activeName" type="border-card">
        ...
        <el-tab-pane label="订舱单(MBL)" name="former_sea_booking">配置管理</el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    initData() {
      getData('/order/masters/' + this.$route.params.id + '/operation', { formerType: 'former_sea_instruction' }, 'get').then(response => {
